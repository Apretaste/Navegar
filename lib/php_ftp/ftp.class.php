...
class FTP
{
    ...
    { // Retrieves various runtime behaviours of
                                   // the current FTP stream
        $this->_resetError();
    ...
    function nb_fget ()
    { // Retrieves a file from the FTP server and writes it
                         // to an open file (non-blocking)
        $this->_resetError();
        // todo
    }
    ...
    { // Returns a detailed list of files
    ...
    { // Returns a parsed rawlist in an assoc
                                       // array
    ...
    function systype ()
    { // Returns the system type identifier of the remote FTP
                         // server
        $this->_resetError();
